...
namespace P2k7.Core.Behavior
{
    public class cls_CM_ProjectSchedule2007
    {
        ...
        public cls_CM_ProjectSchedule2007 GetProjectSchedule(Guid intID, FujinetWMSDLL.ProjectWebSvc.DataStoreEnum whereToGet, bool GetAsAdmin = false)
        {
            FujinetWMSDLL.ProjectWebSvc.Project project = new FujinetWMSDLL.ProjectWebSvc.Project();
            ...
            FujinetWMSDLL.ProjectWebSvc.ProjectDataSet projectDataSet = project.ReadProjectEntities(intID, 1, whereToGet);
        ...
        public cls_CM_ProjectSchedule2007 GetProjectScheduleTempDB(Guid intID, FujinetWMSDLL.ProjectWebSvc.DataStoreEnum whereToGet, bool GetAsAdmin = false)
        {
            FujinetWMSDLL.ProjectWebSvc.Project project = new FujinetWMSDLL.ProjectWebSvc.Project();
            ArrayList arrayList = new ArrayList();
            cls_CM_ProjectSchedule2007 cls_CM_ProjectSchedule = new cls_CM_ProjectSchedule2007();
        ...
        public List<cls_CM_ProjectSchedule2007> GetProjectScheduleList(Guid intID, string strName = "", cls_CM_ResourceOnServer2007 objManager = null, bool OngoingProjectsOnly = true, FujinetWMSDLL.ProjectWebSvc.DataStoreEnum whereToGet = FujinetWMSDLL.ProjectWebSvc.DataStoreEnum.PublishedStore)
        {
            List<cls_CM_ProjectSchedule2007> list = new List<cls_CM_ProjectSchedule2007>();
            ResourceDataSet resourceDS = new ResourceDataSet();
            FujinetWMSDLL.ResourceWebSvc.Resource resource = new FujinetWMSDLL.ResourceWebSvc.Resource();
            cls_CM_Function.OverrideCertificateValidation();
            FujinetWMSDLL.ProjectWebSvc.Project project = new FujinetWMSDLL.ProjectWebSvc.Project();
            project.Url = "https://projectsvr-01.fujinet.vn/PWA/_vti_bin/psi/Project.asmx";
            ...
            FujinetWMSDLL.ProjectWebSvc.ProjectDataSet projectDataSet = new FujinetWMSDLL.ProjectWebSvc.ProjectDataSet();
            ...
            try
            {
                ...
                while (enumerator.MoveNext())
                {
                    ...
                    CS$<> 8__locals1.$VB$Local_oneRow = (FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.ProjectRow)enumerator.Current;
        ...
        public ScheduleStatus GetProjectStatus(FujinetWMSDLL.ProjectWebSvc.ProjectDataSet oneProject, LookupTableDataSet lookupDS)
        {
            try
            {
                foreach (object obj in oneProject.ProjectCustomFields)
                {
                    FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.ProjectCustomFieldsRow projectCustomFieldsRow = (FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.ProjectCustomFieldsRow)obj;
        ...
        public List<cls_CM_ProjectSchedule2007> GetScheduleOfUser(string strUserName, FujinetWMSDLL.ProjectWebSvc.DataStoreEnum whereToGet)
        {
            cls_CM_Function.OverrideCertificateValidation();
            FujinetWMSDLL.ResourceWebSvc.Resource resource = new FujinetWMSDLL.ResourceWebSvc.Resource();
        ...
        public List<cls_CM_ResourceOnServer2007> GetResourceOfSchedule(Guid intProjectID, FujinetWMSDLL.ProjectWebSvc.DataStoreEnum whereToGet)
        {
        ...
        public List<Project2007Task> GetTaskList(int outlineLevel = -1, FujinetWMSDLL.ProjectWebSvc.DataStoreEnum whereToget = FujinetWMSDLL.ProjectWebSvc.DataStoreEnum.PublishedStore, bool WithAssn = false)
        {
            cls_CM_Function.OverrideCertificateValidation();
            FujinetWMSDLL.ProjectWebSvc.Project project = new FujinetWMSDLL.ProjectWebSvc.Project();
            ...
            bool flag = !WithAssn;
            FujinetWMSDLL.ProjectWebSvc.ProjectDataSet projectDataSet;
            if (flag)
            {
            ...
            foreach (FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.TaskRow taskRow in array)
            {
        ...
        public List<Project2007Assignment> GetTaskWithAssignmentList(FujinetWMSDLL.ProjectWebSvc.DataStoreEnum whereToget = FujinetWMSDLL.ProjectWebSvc.DataStoreEnum.PublishedStore, bool viewTaskOfOtherUser = false)
        {
            cls_CM_Function.OverrideCertificateValidation();
            FujinetWMSDLL.ProjectWebSvc.Project project = new FujinetWMSDLL.ProjectWebSvc.Project();
            ...
            lookupTableDS = lookupTable.ReadLookupTables("", false, 0);
            ResourceDataSet resourceDS = new ResourceDataSet();
            resourceDS = new FujinetWMSDLL.ResourceWebSvc.Resource
            {
                Url = "https://projectsvr-01.fujinet.vn/PWA/_vti_bin/PSI/Resource.asmx",
                Credentials = cls_CM_Function.GetCredentials(true)
            }.ReadResources("", false);
            FujinetWMSDLL.ProjectWebSvc.ProjectDataSet projectDataSet = project.ReadProjectEntities(this.ID, 330, whereToget);
            FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.AssignmentRow[] array = (FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.AssignmentRow[])projectDataSet.Assignment.Select();
            foreach (FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.AssignmentRow oneRow in array)
            {
        ...
        // Token: 0x06000DD7 RID: 3543 RVA: 0x000540E4 File Offset: 0x000522E4
        public static object GetTaskCustomFieldValue(FujinetWMSDLL.ProjectWebSvc.ProjectDataSet projectDS, CustomFieldDataSet customFieldDS, LookupTableDataSet lookupTableDS, Guid customFieldUID, FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.TaskRow task)
        {
            FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.TaskCustomFieldsRow[] array = (FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.TaskCustomFieldsRow[])projectDS.TaskCustomFields.Select(string.Concat(new string[]
            {
            ...
            object obj = null;
            bool flag = array.Count<FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.TaskCustomFieldsRow>() <= 0;
            object result;
            if (flag)
            {
                result = null;
        ...
        public static object GetAssignmentCustomFieldValue(FujinetWMSDLL.ProjectWebSvc.ProjectDataSet projectDS, CustomFieldDataSet customFieldDS, LookupTableDataSet lookupTableDS, Guid customFieldUID, FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.AssignmentRow assn)
        {
        ...
        public Project2007Task ConvertTaskRowToProjectTask(FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.TaskRow oneRow, FujinetWMSDLL.ProjectWebSvc.ProjectDataSet onePrj, CustomFieldDataSet customFieldDS, LookupTableDataSet lookupTableDS)
        {
            ...
            FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.AssignmentRow[] array = (FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.AssignmentRow[])onePrj.Assignment.Select(onePrj.Assignment.TASK_UIDColumn.ColumnName + "='" + oneRow.TASK_UID.ToString() + "'");
            project2007Task.AssignmentUID = new List<Guid>();
            foreach (FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.AssignmentRow assignmentRow in array)
            {
            ...
            int num11 = 0;
            int num12 = 0;
            foreach (FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.AssignmentRow assn in array)
            {
        ...
        public Project2007Assignment ConvertAssignementRowToProjectAssignment(FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.AssignmentRow oneRow, FujinetWMSDLL.ProjectWebSvc.ProjectDataSet onePrj, CustomFieldDataSet customFieldDS, LookupTableDataSet lookupTableDS, ResourceDataSet resourceDS)
        {
        ...
        public Project2007Task GetTaskInfo(Guid TaskUniqueID, FujinetWMSDLL.ProjectWebSvc.DataStoreEnum whereToGet)
        {
            cls_CM_Function.OverrideCertificateValidation();
            FujinetWMSDLL.ProjectWebSvc.Project project = new FujinetWMSDLL.ProjectWebSvc.Project();
            ArrayList arrayList = new ArrayList();
            ...
            lookupTable.Credentials = cls_CM_Function.GetCredentials(false);
            lookupTableDS = lookupTable.ReadLookupTables("", false, 0);
            FujinetWMSDLL.ProjectWebSvc.ProjectDataSet projectDataSet = project.ReadProjectEntities(this.ID, 66, whereToGet);
            DataRow dataRow = projectDataSet.Task.FindByTASK_UIDPROJ_UID(TaskUniqueID, this.ID);
            return this.ConvertTaskRowToProjectTask((FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.TaskRow)dataRow, projectDataSet, customFieldDS, lookupTableDS);
        }
        ...
        {
            List<Project2007Task> taskList = this.GetTaskList(-1, FujinetWMSDLL.ProjectWebSvc.DataStoreEnum.PublishedStore, false);
            int i = 0;
            checked
            {
        ...
        public Project2007Task GetParentTask(Guid TaskUniqueID, FujinetWMSDLL.ProjectWebSvc.DataStoreEnum whereToGet = FujinetWMSDLL.ProjectWebSvc.DataStoreEnum.PublishedStore)
        {
            cls_CM_Function.OverrideCertificateValidation();
            FujinetWMSDLL.ProjectWebSvc.Project project = new FujinetWMSDLL.ProjectWebSvc.Project();
            project.Url = "https://projectsvr-01.fujinet.vn/PWA/_vti_bin/psi/Project.asmx";
            ...
            lookupTableDS = lookupTable.ReadLookupTables("", false, 0);
            FujinetWMSDLL.ProjectWebSvc.ProjectDataSet projectDataSet = project.ReadProjectEntities(this.ID, 66, whereToGet);
            FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.TaskRow taskRow = projectDataSet.Task.FindByTASK_UIDPROJ_UID(TaskUniqueID, this.ID);
        ...
        public List<cls_CM_ResourceOnServer2007> GetSummaryTimephasedData(DateTime StartDate, DateTime EndDate, cls_CM_ResourceOnServer2007 Resource = null, FujinetWMSDLL.ProjectWebSvc.DataStoreEnum whereToGet = FujinetWMSDLL.ProjectWebSvc.DataStoreEnum.PublishedStore)
        {
            cls_CM_Function.OverrideCertificateValidation();
            List<cls_CM_ResourceOnServer2007> list = new List<cls_CM_ResourceOnServer2007>();
            ...
            project.Url = "https://projectsvr-01.fujinet.vn/PWA/_vti_bin/psi/Project.asmx";
            project.Credentials = cls_CM_Function.GetCredentials(false);
            FujinetWMSDLL.ProjectWebSvc.ProjectDataSet projectDataSet = project.ReadProjectEntities(this.ID, 74, whereToGet);
            ...
            try
            {
                ...
                {
                    FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.AssignmentRow assignmentRow = (FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.AssignmentRow)obj;
        ...
        public static List<Task2007Info> GetAllProjectTimephasedData(DateTime StartDate, DateTime EndDate, FujinetWMSDLL.ProjectWebSvc.DataStoreEnum whereToGet = FujinetWMSDLL.ProjectWebSvc.DataStoreEnum.PublishedStore, cls_CM_ResourceOnServer2007 Resource = null)
        {
        ...
        private static void GetResourceInfo(Guid resGuid, ref string resName, ref string resNTAccount, ResourceDataSet resourceDS)
        {
        ...
        public static List<Task2007Info> GetTaskSummaryTimephasedData(cls_CM_ProjectSchedule2007 schedule, DateTime StartDate, DateTime EndDate, FujinetWMSDLL.ProjectWebSvc.DataStoreEnum whereToGet = FujinetWMSDLL.ProjectWebSvc.DataStoreEnum.PublishedStore, cls_CM_ResourceOnServer2007 Resource = null)
        {
            ...
            FujinetWMSDLL.ProjectWebSvc.ProjectDataSet projectDataSet = project.ReadProjectEntities(schedule.ID, 74, whereToGet);
            string fixbugWBS;
            string devWBS;
            string manWBS;
            ...
            try
            {
                foreach (object obj in projectDataSet.Assignment)
                {
                    ...
                    FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.TaskRow taskRow = projectDataSet.Task.FindByTASK_UIDPROJ_UID(assignmentRow.TASK_UID, assignmentRow.PROJ_UID);
        ...
        public List<Task2007Info> GetTaskDetailTimephasedData(DateTime StartDate, DateTime EndDate, FujinetWMSDLL.ProjectWebSvc.DataStoreEnum whereToGet = FujinetWMSDLL.ProjectWebSvc.DataStoreEnum.PublishedStore, cls_CM_ResourceOnServer2007 Resource = null)
        {
            cls_DB_ProjectSchedule2007 cls_DB_ProjectSchedule = new cls_DB_ProjectSchedule2007();
        ...
        public void GetTaskSummaryTimephasedData_ClassifyProjectAndNonProject(ref ArrayList ProjectTaskList, ref ArrayList NonProjectTaskList, DateTime StartDate, DateTime EndDate, FujinetWMSDLL.ProjectWebSvc.DataStoreEnum whereToGet = FujinetWMSDLL.ProjectWebSvc.DataStoreEnum.PublishedStore, cls_CM_ResourceOnServer2007 Resource = null)
        {
        ...
        public void GetTaskDetailTimephasedData_ClassifyProjectAndNonProject(ref ArrayList ProjectTaskList, ref ArrayList NonProjectTaskList, DateTime StartDate, DateTime EndDate, FujinetWMSDLL.ProjectWebSvc.DataStoreEnum whereToGet = FujinetWMSDLL.ProjectWebSvc.DataStoreEnum.PublishedStore)
        {
        ...
        public List<cls_CM_ProjectSchedule2007> GetDirectScheduleOfUser(string userID, bool OnlyForManaging = false)
        {
            ...
            list = cls_CM_ProjectSchedule.GetProjectScheduleList(Guid.Empty, "", null, true, FujinetWMSDLL.ProjectWebSvc.DataStoreEnum.PublishedStore);
        ...
        public bool IsParentOf(Task2007Info parentTask, Task2007Info childTask, FujinetWMSDLL.ProjectWebSvc.ProjectDataSet projectDS)
        {
            for (; ; )
            {
        ...
        // Token: 0x06000DF2 RID: 3570 RVA: 0x00056704 File Offset: 0x00054904
        public static void GetWBSTaskClass(FujinetWMSDLL.ProjectWebSvc.ProjectDataSet project, ref string FixBugTaskWBS, ref string DevelopmentTaskWBS, ref string ManagementTaskWBS)
        {
            FixBugTaskWBS = "-1";
            ManagementTaskWBS = "-1";
            DevelopmentTaskWBS = "-1";
            FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.TaskCustomFieldsRow[] array = (FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.TaskCustomFieldsRow[])project.TaskCustomFields.Select(string.Format("{0} = '{1}' AND {2} = '{3}'", new object[]
            {
            ...
            if (flag)
            {
                foreach (FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.TaskCustomFieldsRow taskCustomFieldsRow in array)
                {
                    FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.TaskRow[] array3 = (FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.TaskRow[])project.Task.Select(string.Format("{0} = '{1}' AND {2} = '{3}'", new object[]
                    {
                    ...
                    bool flag2 = array3 != null && array3.Count<FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.TaskRow>() == 1;
                    if (flag2)
                    {
            ...
            FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.TaskCustomFieldsRow[] array4 = (FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.TaskCustomFieldsRow[])project.TaskCustomFields.Select(string.Format("{0} = '{1}' AND {2} = '{3}'", new object[]
            {
                project.TaskCustomFields.MD_PROP_UIDColumn.ColumnName,
                "000039b7-8bbe-4ceb-82c4-fa8c0b40031f",
                project.TaskCustomFields.TEXT_VALUEColumn.ColumnName,
            ...
            if (flag3)
            {
                foreach (FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.TaskCustomFieldsRow taskCustomFieldsRow2 in array4)
                {
                    FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.TaskRow[] array6 = (FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.TaskRow[])project.Task.Select(string.Format("{0} = '{1}' AND {2} = '{3}'", new object[]
                    {
                        project.Task.TASK_NAMEColumn.ColumnName,
                        "Project Management",
                        project.Task.TASK_UIDColumn.ColumnName,
                    ...
                    bool flag4 = array6 != null && array6.Count<FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.TaskRow>() == 1;
                    if (flag4)
                    {
            ...
            FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.TaskCustomFieldsRow[] array7 = (FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.TaskCustomFieldsRow[])project.TaskCustomFields.Select(string.Format("{0} = '{1}' AND {2} = '{3}'", new object[]
            {
                project.TaskCustomFields.MD_PROP_UIDColumn.ColumnName,
                "000039b7-8bbe-4ceb-82c4-fa8c0b40031f",
                project.TaskCustomFields.TEXT_VALUEColumn.ColumnName,
            ...
            bool flag5 = array7 != null;
            if (flag5)
            {
                foreach (FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.TaskCustomFieldsRow taskCustomFieldsRow3 in array7)
                {
                    FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.TaskRow[] array9 = (FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.TaskRow[])project.Task.Select(string.Format("{0} = '{1}' AND {2} = '{3}'", new object[]
                    {
                        project.Task.TASK_NAMEColumn.ColumnName,
                    ...
                    bool flag6 = array9 != null && array9.Count<FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.TaskRow>() == 1;
                    if (flag6)
                    {
        ...
        // Token: 0x06000DF3 RID: 3571 RVA: 0x00056A90 File Offset: 0x00054C90
        ...
        // Token: 0x06000DF4 RID: 3572 RVA: 0x00056AF4 File Offset: 0x00054CF4
        public static void GetSubPrjListWBS(FujinetWMSDLL.ProjectWebSvc.ProjectDataSet project, ref List<string> subPrjWBS, ref List<string> subPrjName, LookupTableDataSet lookuptableDS)
        {
            subPrjWBS = new List<string>();
            subPrjName = new List<string>();
            LookupTableDataSet.LookupTablesRow[] array = (LookupTableDataSet.LookupTablesRow[])lookuptableDS.LookupTables.Select(string.Format("{0} = '{1}'", lookuptableDS.LookupTables.LT_NAMEColumn.ColumnName, "TaskClass"));
            Guid guid = Guid.Empty;
            bool flag = array != null && array.Count<LookupTableDataSet.LookupTablesRow>() > 0;
            if (flag)
            {
                guid = array[0].LT_UID;
            }
            LookupTableDataSet.LookupTableTreesRow[] array2 = (LookupTableDataSet.LookupTableTreesRow[])lookuptableDS.LookupTableTrees.Select(string.Format("{0} = '{1}' AND {2} = '{3}'", new object[]
            {
            ...
            bool flag2 = array2 != null && array2.Count<LookupTableDataSet.LookupTableTreesRow>() > 0;
            if (flag2)
            {
                FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.TaskCustomFieldsRow[] array3 = (FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.TaskCustomFieldsRow[])project.TaskCustomFields.Select(string.Format("{0} = '{1}' AND {2} = '{3}'", new object[]
                {
                    project.TaskCustomFields.MD_PROP_UIDColumn.ColumnName,
                ...
                if (flag3)
                {
                    foreach (FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.TaskCustomFieldsRow taskCustomFieldsRow in array3)
                    {
                        FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.TaskRow[] array5 = (FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.TaskRow[])project.Task.Select(string.Format("{0} = '{1}'", project.Task.TASK_UIDColumn.ColumnName, taskCustomFieldsRow.TASK_UID.ToString()));
                        bool flag4 = array5 != null && array5.Count<FujinetWMSDLL.ProjectWebSvc.ProjectDataSet.TaskRow>() == 1;
                        if (flag4)
                        {
        ...
        // Token: 0x06000DF5 RID: 3573 RVA: 0x00056D00 File Offset: 0x00054F00
