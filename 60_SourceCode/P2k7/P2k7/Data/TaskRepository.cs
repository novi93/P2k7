...
namespace P2k7.Data
{
    public class TaskRepository : PsiRepository
    {
        public CustomFieldRepository CfRepo { get; }
        public ProjectRepository PrjRepo { get; }

        public TaskRepository(MySettings mySettings, CustomFieldRepository CfRepo, ProjectRepository PrjRepo) : base(mySettings)
        {
            this.CfRepo = CfRepo;
        ...
        public IEnumerable<TaskInfo> GetTaskSummaryTimephasedDataNew(Guid schedule_ID, DateTime StartDate, DateTime EndDate, DataStoreEnum whereToGet = DataStoreEnum.PublishedStore)
        {
            // truncate time
